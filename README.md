...
Aplicação Front-end Mobile desenvolvida em React Native para layout de aplicativo PWA (Progressive Web App) via Expo, que simula uma aplicação nativa nas multiplataformas iOS, Android e Web (PWA) sendo executada dentro do browser a partir do aplicativo escrito em React Native. Usa dados vindo da API do Github e a manipulação básica da câmera para ter a melhor visualização de um exemplo real de app.
