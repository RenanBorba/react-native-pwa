...
Aplicação Front-end Mobile desenvolvida em React Native para layout de aplicativo PWA (Progressive Web App) via Expo, que simula uma aplicação nativa funcionando dentro do browser, para exemplificar o uso a partir do aplicativo mobile escrito em React Native para iOS, Android e PWA (web) ao mesmo tempo. Usa dados vindo da API do Github e a manipulação básica da câmera, para ter de fato a melhor visualização de um exemplo real de app.
